...
public class programacion3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_programacion3);
        i=new Intent(programacion3.this,scorep.class);
