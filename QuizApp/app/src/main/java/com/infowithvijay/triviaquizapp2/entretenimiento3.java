...
public class entretenimiento3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entretenimiento3);
        i=new Intent(entretenimiento3.this, scoree.class);
