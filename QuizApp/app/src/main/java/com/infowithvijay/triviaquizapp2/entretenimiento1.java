...
public class entretenimiento1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entretenimiento1);
        i=new Intent(entretenimiento1.this,entretenimiento2.class);
