...
public class entretenimiento2 extends AppCompatActivity implements View.OnClickListener {
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entretenimiento2);
        i=new Intent(entretenimiento2.this,entretenimiento3.class);
